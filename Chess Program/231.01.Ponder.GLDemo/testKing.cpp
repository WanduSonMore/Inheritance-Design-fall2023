...
//	// VERIFY
//	assert(move.find(Move("e5d6")) != move.end());
//	assert(move.find(Move("e5e6")) != move.end());
//	assert(move.find(Move("e5f6")) != move.end());
//	assert(move.find(Move("e5d5")) != move.end());
//	assert(move.find(Move("e5f5")) != move.end());
//	assert(move.find(Move("e5d4")) != move.end());
//	assert(move.find(Move("e5e4")) != move.end());
//	assert(move.find(Move("e5f4")) != move.end());
//	// TEARDOWN
//}
//
